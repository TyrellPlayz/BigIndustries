...
import com.tyrellplayz.big_industries.menu.AbstractMenu;
...
public class FuelSlot extends Slot {
    ...
    public FuelSlot(AbstractMenu menu, Container container, RecipeType<? extends AbstractCookingRecipe> recipeType, FuelType fuelType, int slot, int x, int y) {
