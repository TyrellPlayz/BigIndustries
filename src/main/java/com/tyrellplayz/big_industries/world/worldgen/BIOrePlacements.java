...
public class BIOrePlacements {
    ...
    public static Holder<PlacedFeature> ORE_TIN;
    public static Holder<PlacedFeature> ORE_LEAD;
    public static Holder<PlacedFeature> ORE_ALUMINIUM;
    public static Holder<PlacedFeature> ORE_SILVER;
    public static Holder<PlacedFeature> ORE_NICKEL;

    private BIOrePlacements() {}

    public static void init() {
        ORE_TIN = PlacementUtils.register(modLoc("ore_tin"),BIOreFeatures.ORE_TIN
                ,commonOrePlacement(20,HeightRangePlacement.triangle(VerticalAnchor.absolute(38),VerticalAnchor.absolute(112))));

        ORE_LEAD = PlacementUtils.register(modLoc("ore_lead"),BIOreFeatures.ORE_LEAD
                ,commonOrePlacement(15,HeightRangePlacement.triangle(VerticalAnchor.bottom(),VerticalAnchor.absolute(30))));

        ORE_ALUMINIUM = PlacementUtils.register(modLoc("ore_aluminium"),BIOreFeatures.ORE_ALUMINIUM
                ,commonOrePlacement(20,HeightRangePlacement.triangle(VerticalAnchor.absolute(0),VerticalAnchor.absolute(56))));

        ORE_SILVER = PlacementUtils.register(modLoc("ore_silver"),BIOreFeatures.ORE_SILVER
                ,commonOrePlacement(15,HeightRangePlacement.triangle(VerticalAnchor.absolute(-15),VerticalAnchor.absolute(56))));

        ORE_NICKEL = PlacementUtils.register(modLoc("ore_nickel"), BIOreFeatures.ORE_NICKEL
                ,commonOrePlacement(15,HeightRangePlacement.triangle(VerticalAnchor.bottom(),VerticalAnchor.absolute(20))));
    }
